                ...
                <CardContent className="flex items-start gap-3 p-4">
                  ...
                  <div className="min-w-0 flex-1 space-y-2">
                    ...
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <button
                        className="text-xs font-medium text-muted-foreground underline-offset-4 hover:text-foreground hover:underline sm:text-[13px]"
                    ...
                    <div className="flex items-center gap-2 text-[15px] font-semibold text-foreground sm:text-base">
